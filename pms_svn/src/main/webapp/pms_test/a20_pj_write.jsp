						...
						<form method="post" enctype="multipart/form-data" action="${path}/board.do?method=insert">
							...
							<div class="input-group mb-3">
								<div class="input-group-prepend">
									...
									<input type="date" name="project_start" class="form-control" value="${project.project_start}"/>
								<div class="input-group-prepend">
									<span class="input-group-text">종료일</span>
								</div>
									<input type="date" name="project_end" class="form-control" value="${project.project_end}"/>			 
							</div> 
							
							<!-- 예산 -->
							<div class="input-group mb-3">
								<div class="input-group-prepend">
									<span class="input-group-text">예산(원)</span>
								</div>
									<input type="number" name="project_money" class="form-control" value="${project.project_money}"/>
							</div> 
							...
							<div class="input-group mb-3 fileCls">
 							...
 							<div style="text-align:right;">
								...
								<input type="button" class="btn btn-primary" value="메인 화면으로" id="goMain"/>
							</div>	
					</div>   
