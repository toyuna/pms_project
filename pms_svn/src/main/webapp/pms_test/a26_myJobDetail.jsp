            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="">Meeting</a>
                        <a class="collapse-item" href="">Work</a>
                        <a class="collapse-item" href="">Outputs</a>
                    </div>
                </div>
            </li>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
				...
				<div class="container-fluid">
					...
					<div class="container">
						<form method="post" enctype="multipart/form-data" action="${path}/myjobdetail.do">
							...
							<div class="input-group mb-3 fileCls">	
								<div class="input-group-prepend">
									...
									<input name="no" class="form-control" value="${myjob.meeting_list_num}" readonly/>	
								<div class="input-group-prepend">
							...
							<div class="input-group mb-3">
								<div class="input-group-prepend">
									...
									<input name="title" class="form-control" value="${meetingList.meeting_name}" />			 
							</div> 
							...
							<div class="input-group mb-3 fileCls">	
								<div class="input-group-prepend">
									...
									<input name="writer" class="form-control" placeholder="" value="${meetingList.name}" readonly/>
								<div class="input-group-prepend">
									<span class="input-group-text">조회수</span>
								</div>
									<input name="readcnt" class="form-control" value="${board.readcnt}" readonly/>	
							</div>	
							...
							<div class="input-group mb-3 fileCls">	
								<div class="input-group-prepend">
									...
									<input class="form-control"   
											value='<fmt:formatDate type="both" value="${meetingList.project_start}" />'/>	
								<div class="input-group-prepend">
